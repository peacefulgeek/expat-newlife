/**
 * Production entry point — starts web server + registers all cron jobs.
 * Section 8B of the Master Scope.
 * NO setTimeout for scheduling. Cron expressions only.
 */
...
if (!AUTO_GEN) {
  ...
  try {
    ...
    // Phase 2 (published_count >= 60): 1 fire/weekday at 08:00 UTC
