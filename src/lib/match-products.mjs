/**
 * Product matching engine — Section 10D of the Master Scope.
 * Uses named parameters only (never positional — the argument-flip bug brought down sites).
 */

export function matchProducts({
  articleTitle, articleTags, articleCategory, catalog,
...
function scoreProduct(product, title, tags, category) {
  ...
  for (const tag of tags) if (productTags.includes(tag)) score += 3;
